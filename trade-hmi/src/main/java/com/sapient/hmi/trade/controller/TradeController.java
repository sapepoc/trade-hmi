...
public class TradeController {
	...
	public @ResponseBody ResponseEntity applyRules(@RequestBody RequestEntity requestEntity){
		return new ResponseEntity(Boolean.TRUE, tradeService.applyRules(requestEntity));
	}
}
